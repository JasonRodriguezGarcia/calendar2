...
const InfoJobsIconMui = (props) => (
  <SvgIcon {...props} viewBox="0 0 138 136.054">
    <path
...
export default InfoJobsIconMui
// Como usarlo
// import ExcelIconMui from "./components/icons/ExcelIconMui";

// <Button variant="contained" startIcon={<ExcelIconMui />}>
//   Exportar a Excel
// </Button>