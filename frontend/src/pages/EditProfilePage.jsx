...
const EditProfilePage = ({ logged, setLogged, user, setUser, token }) =>{
    ...
    return (
        ...
        <Box sx={{
            ...
            <UsersCRUDComponent logged={logged} setLogged={setLogged} user={user} setUser={setUser} action="update" token={token}/>
        </Box>
        </>
    )
}
