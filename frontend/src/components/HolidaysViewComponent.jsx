...
const HolidaysViewComponent = ({ logged, user }) => {
    ...
    useEffect(() => {
        ...
        // const month = today.getMonth(); // OJO: 0 = Enero, 11 = Diciembre
        ...
        //     tempRows.push({usuario: usuario.usuario_id, nombre_apellidos, fechas: [events.filter(evento => (evento.usuario_id === usuario.usuario_id))]})
        // ))
        ...
        <Box>
            <TableContainer component={Paper}>
                <Table sx={{ minWidth: 650 }} aria-label="simple table">
                    <TableHead>
                        <TableRow>
                            <TableCell align="left" sx={{ borderRight: '1px solid rgba(0, 0, 0, 0.12)'}}>Usuario</TableCell>
                    ...
                    <TableBody>
                        {rows.map((row, index) => (
                            ...
                            >
                                <TableCell component="th" scope="row"  sx={{ borderRight: '1px solid rgba(0, 0, 0, 0.12)'}}>
                                ...
                                {actualMonthDays.map((day, dayIndex) => {
                                    ...
                                    return (
                                        <TableCell
                                            ...
                                            align="center"
                                            sx={{
                                                // backgroundColor: tieneEvento ? '#dff0d8' : 'transparent',
                                                backgroundColor: tieneEvento ? 'red' : 'transparent',
